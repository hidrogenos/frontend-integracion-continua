        ...
        const newEquipo: EquipoModel =
            {
                ...
                serial: this.formEquipoDetalle.value.area,
                marca: this.formEquipoDetalle.value.area,
                software: this.formEquipoDetalle.value.area,
                observaciones: this.formEquipoDetalle.value.area,
