...
export class BeAccionesCorrectivasAsocComponent {
    ...
    @Output()
    onSelectAccionCorrectiva: EventEmitter<any> = new EventEmitter<any>();
    ...
    verDetalleAccionCorrectiva(idAccionCorrectiva: number, event: MouseEvent) {
        let infoAccionCo = {
            idAccionCorrectiva: idAccionCorrectiva, event: event
        }
        this.onSelectAccionCorrectiva.emit(infoAccionCo);
    }
}
