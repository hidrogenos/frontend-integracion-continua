                ...
                <div class="ui-g">
                    <div class="ui-g-12">
                        <p-toolbar>
                            ...
                            <div class="ui-g ui-fluid" *ngIf="(idAccionCorrectivaEstado == ACCION_ASIGNADA) && (usuarioActual?.id == accionCorrectivaActual?.id_responsable)">
                                <div class="ui-g-6">
                            ...
                            <div class="ui-g ui-fluid" *ngIf="(idAccionCorrectivaEstado == ACCION_EN_ANALISIS) && (usuarioActual?.id == accionCorrectivaActual?.id_responsable)">
                                <div class="ui-g-12">
                            ...
                            <div class="ui-g ui-fluid" *ngIf="(idAccionCorrectivaEstado == ACCION_EN_ASIGNACION_ACTIVIDADES) && (usuarioActual?.id == accionCorrectivaActual?.id_responsable) && finishedTareaPermiso">
                                <div class="ui-g-12">
...
export class AccionCorrectivaPanel extends ComponenteCargado implements OnInit {
        ...
        this.store
            ...
            .subscribe(routerId => {
                ...
                let aux2 = forkJoin([
                    ...
                    this.getJefesProcesos()
                ]);

                aux2.subscribe(([tareaTipos, usuarios, jefesProcesosHijos]) => {
                    this.tareaTipos = tareaTipos;
                    this.usuarios = usuarios;
                    this.jefesProcesosHijos = jefesProcesosHijos;
                });
            });
    }
    ...
    updateAccionCorrectiva(data: AccionCorrectivaModel) {
        this.showWaitDialog(
            "Acción en proceso",
            "Actualizando información acción correctiva, un momento por favor..."
        );
    ...
    deleteDocumentoFromAccionCorrectiva(event: AccionCorrectivaAdjuntoModel) {
        this.showWaitDialog(
            "Accion en proceso",
            "Eliminando documento de acción correctiva"
        );
        this.accionCorrectivaDocumentoService
    ...
    updateAccionCorrectivaTarea(data: AccionCorrectivaTareaModel) {
        this.showWaitDialog(
            "Accion en proceso",
            "Actualizando información tarea acción correctiva"
        );
        this.accionesCorrectivasTareaService
    ...
    deleteAccionCorrectivaTarea(data: AccionCorrectivaTareaModel) {
        this.showWaitDialog(
            "Acción en proceso",
            "Eliminando tarea acción correctiva, un momento por favor..."
        );
        this.accionesCorrectivasTareaService
